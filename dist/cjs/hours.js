...
exports.Hours = exports.incrementDay = exports.getDayIndex = exports.getDayString = exports.DAYS = void 0;
...
class Hours {
    ...
    compileTimes(text) {
        ...
        for (const match of matches) {
            objects.push(new chronos_1.Chronos(match, false));
        }
        if (objects.length < 2) {
    ...
    constructor(arg1, max, breaks, time_zone_offset = 0) {
        ...
        if (arguments.length === 1) {
            this.min = new chronos_1.Chronos();
            this.max = new chronos_1.Chronos();
            this.breaks = [];
        ...
        this.min = new chronos_1.Chronos(Number(arg1), false);
        this.max = new chronos_1.Chronos(max, false);
        this.breaks = (breaks === null || breaks === void 0 ? void 0 : breaks.map((item) => new chronos_1.Chronos(item, false))) || [];
